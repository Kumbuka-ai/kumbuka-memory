...
import ai.kumbuka.memory.tenancy.TenantMigrationCallback;
...
/**
 * V2 refuses to run against a wrongly-shaped service
 ...
 * ai.kumbuka.memory.tenancy.ColdStartIT} asserts both attributes are absent
