 ...
 * refuses few things — it holds a schema and one read contract, and has no
 * verbs. The refusals of the entry surface arrive with the surface and bring
 * their own reasons. Enumerating them here in advance would be guessing at
 * refusals nothing can yet raise.
 */
public class MemoryException extends RuntimeException {
    ...
    public MemoryException(Reason reason, String message, List<String> offenders) {
        super(message);
        this.reason = reason;
